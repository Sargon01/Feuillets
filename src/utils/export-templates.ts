...
export const EXPORT_TEMPLATES: Record<string, ResolvedExportTemplate> = {
  ...
  moderne: {
    ...
    marginsCm: { top: 1.5, bottom: 1.5, left: 1.5, right: 1.5 },
    paragraphSpacing: false,
...
export function templateToCss(tpl: ExportTemplate) {
  ...
  return [
    ...
    "}",
    "p {",
    `  margin: ${tpl.paragraphSpacingAfterPt != null
      ? `${tpl.paragraphSpacingPt ?? 0}pt 0 ${tpl.paragraphSpacingAfterPt}pt 0`
      : tpl.paragraphSpacing
        ? "0 0 1em 0"
        : (tpl.paragraphSpacingPt ? `${tpl.paragraphSpacingPt}pt 0 0 0` : "0")};`,
