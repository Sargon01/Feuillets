...
export class GrammarUserData {
  ...
  load() {
    ...
    try {
      ...
      this.knownWords = Array.isArray(data.knownWords) ? data.knownWords : [];
      this.ignoredRules = Array.isArray(data.ignoredRules) ? data.ignoredRules : [];
    } catch {
      this.knownWords = [];
      this.ignoredRules = [];
    }
  ...
  migrateFromSettings(settings) {
    const oldWords = Array.isArray(settings.grammalecteKnownWords) ? settings.grammalecteKnownWords : [];
    const oldRules = Array.isArray(settings.grammalecteIgnoredRules) ? settings.grammalecteIgnoredRules : [];
