...
if (typeof(exports) !== 'undefined') {
    // Patché pour Feuillets : les méthodes exportées telles quelles perdaient
    // leur `this` (elles lisaient this.oColorType/this.oOptColor, propres à
    // l'objet interne gc_options, pas à l'objet exports) ; on les relie
    // explicitement. Le nom "dColorType" (au lieu de "oColorType") était
    // aussi une faute de frappe amont qui rendait la propriété inaccessible.
    exports.dOptions = gc_options.dOptions;
    exports.sAppContext = gc_options.sAppContext;
    exports.load = gc_options.load.bind(gc_options);
    exports.setOption = gc_options.setOption.bind(gc_options);
    exports.setOptions = gc_options.setOptions.bind(gc_options);
    exports.resetOptions = gc_options.resetOptions.bind(gc_options);
    exports.getDefaultOptions = gc_options.getDefaultOptions.bind(gc_options);
    exports.getOptions = gc_options.getOptions.bind(gc_options);
    exports.getOptionsColors = gc_options.getOptionsColors.bind(gc_options);
