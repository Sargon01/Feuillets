...
var gc_engine = {
    ...
    load: function (sContext="JavaScript", sColorType="aRGB", sPath="", sDictionary="fr-classic.json") {
        // sDictionary : patché pour Feuillets (upstream codait "fr-allvars.json" en dur) —
        // seul fr-classic.json est distribué avec le plugin.
        try {
            if (typeof(process) !== 'undefined') {
                this.oSpellChecker = new spellchecker.SpellChecker("fr", "", sDictionary, "", "");
            } else {
                this.oSpellChecker = new SpellChecker("fr", sPath, sDictionary, "", "");
            }
