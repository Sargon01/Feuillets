...
Dans Feuillets, ces fonctions sont réparties entre plusieurs sections du panneau droit.
...
Feuillets sépare donc davantage les intentions :

- **Notes** pour accompagner l’écriture ;
- **Propriétés** pour décrire et classer le feuillet ;
...
Dans Feuillets, le panneau **Recherche** constitue la bible du projet.
...
Pendant que vous écrivez, le panneau Notes peut faire remonter :
...
- les références épinglées dans le panneau Contexte.
...
- notes de travail dans le panneau Notes ;
...
Feuillets utilise aussi la date du feuillet dans le panneau Contexte pour vérifier la cohérence des personnages, objets et événements.
...
2. Vérifiez le Binder dans Feuillets.
...
7. Testez le panneau Recherche et le Contexte.
